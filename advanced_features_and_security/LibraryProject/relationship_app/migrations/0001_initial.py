    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('added_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='relationship_books_added', to=settings.AUTH_USER_MODEL)),
